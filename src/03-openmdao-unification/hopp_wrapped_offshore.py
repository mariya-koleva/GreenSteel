...
def run(args):
    ...
    filename_orbit_config = os.path.realpath(os.path.join(".", "input", "plant", f"orbit-config-{turbine_model}.yaml"))
    filename_turbine_yaml = os.path.realpath(os.path.join(".", "input", "turbines", f"{turbine_model}.yaml"))
    filename_floris_config = os.path.realpath(os.path.join(".", "input", "floris", "floris_input_iea_18MW_osw.yaml"))
    ...
    if plant_size != None:
        ...
        plant_config["plant"]["num_turbines"] = int(
            plant_size / turbine_config["turbine_rating"]
        )
    ...
    def energy_internals(
        ...
        (
            ...
            plant_config, electrolyzer_physics_results, design_scenario, verbose=verbose
        )
...
if __name__ == "__main__":
    ...
    print(f"lcoe: {lcoe:0.4f}")
    print(f"lcoh: {lcoh:0.3f}")
